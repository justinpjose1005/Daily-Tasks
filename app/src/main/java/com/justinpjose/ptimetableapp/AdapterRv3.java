...
public class AdapterRv3 extends RecyclerView.Adapter<AdapterRv3.ViewHolder> {
    ...
    AdapterRv3(Context context, List<String> mTitles, List<String> mDates, List<String> mTimes, List<String> mNotes) {
    ...
    public interface ItemClickListener {
        void onItemClick3(View view, int adapterPosition);
    }
}
