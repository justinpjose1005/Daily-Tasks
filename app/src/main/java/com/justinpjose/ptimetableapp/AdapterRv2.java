...
public class AdapterRv2 extends RecyclerView.Adapter<AdapterRv2.ViewHolder> {
    ...
    AdapterRv2(Context context, List<String> mTitles, List<String> mDates, List<String> mTimes, List<String> mNotes) {
    ...
    public interface ItemClickListener {
        void onItemClick2(View view, int adapterPosition);
    }
}
